...
{
    public class FoodProductProvider : ProductProviderBase, IProductProvider
    {
        public FoodProductProvider(IUnitOfWork unitOfWork, IMapper mapper, ILogger logger, IConfiguration configuration)
